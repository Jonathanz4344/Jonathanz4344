...
### 🧠 RemitAI
> HIPAA-compliant AI platform for healthcare revenue cycle management. Automates insurance denial classification and generates appeal letters.
 
**Stack:** `FastAPI` `PostgreSQL` `React` `TypeScript` `AWS Bedrock` `Amazon Nova Pro`
 
---
 
### 📚 Enlighten Learning
> Full-stack site for a nonprofit supporting tutoring programs for underserved communities across Long Island.
 
**Stack:** `React` `TypeScript` `Material UI` `Google Apps Script`
